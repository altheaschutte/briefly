...
extension Color {
    ...
    // Use system dynamic colors so glass material adapts contrast automatically.
    static let brieflyTabBarActive = Color(UIColor.label)
    static let brieflyTabBarInactive = Color(UIColor.secondaryLabel)
