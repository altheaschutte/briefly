      ...
      <section className="relative isolate w-full min-h-[min(calc(100svh-4.5rem),52rem)] overflow-visible px-0 py-[clamp(1.75rem,4vh,3rem)]">
        <div className="container relative grid items-center justify-items-center gap-[clamp(2rem,6vh,4rem)] text-center lg:grid-cols-[1.05fr_0.95fr] lg:justify-items-start lg:text-left">
          <div className="space-y-6">
            ...
            Briefly turns the things you care about into high-quality audio — so when you are on the go, you don’t waste time browsing. Just press play.
            </p>

            <div className="flex flex-wrap items-center justify-center gap-6 md:pt-8 lg:justify-start">
              <Link
                href="/#"
              ...
              <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-tealSoft/50">
                  Android coming soon
                  </span>
            </div>
          </div>
